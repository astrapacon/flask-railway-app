...
def health():
    ...
    from modules.workato.routes import bp as workato_bp
    from modules.matricula.routes import bp as matricula_bp

    app.register_blueprint(auth_bp, url_prefix="/auth")          # /auth/login
    app.register_blueprint(workato_bp, url_prefix="/workato")    # /workato/receber, /workato/chamar
    app.register_blueprint(matricula_bp, url_prefix="/matricula")# /matricula/gerar
